...
public class BoardGameRequestDto {
    ...
    @NotNull(message = "Recommended age cannot be null")
    @Min(value = 1, message = "Recommended age should be positive integer number")
    private int recommendedAge;
    @NotNull(message = "Minimum number of players cannot be null")
    ...
    @NotNull(message = "Estimated playtime cannot be null")
